...
public class BedrockNoteBlockPreTransformHandler implements BlockPreTransformHandler {
    public static final Map<ChunkerBlockType, NoteBlockInstrument> INSTRUMENTS = ImmutableMap.<ChunkerBlockType, NoteBlockInstrument>builder()
            ...
            .put(ChunkerVanillaBlockType.COPPER_BLOCK, NoteBlockInstrument.TRUMPET)
            .put(ChunkerVanillaBlockType.EXPOSED_COPPER, NoteBlockInstrument.TRUMPET_EXPOSED)
            .put(ChunkerVanillaBlockType.WEATHERED_COPPER, NoteBlockInstrument.TRUMPET_WEATHERED)
            .put(ChunkerVanillaBlockType.OXIDIZED_COPPER, NoteBlockInstrument.TRUMPET_OXIDIZED)
            ...
            .put(ChunkerVanillaBlockType.OXIDIZED_CUT_COPPER, NoteBlockInstrument.TRUMPET_OXIDIZED)
            .put(ChunkerVanillaBlockType.WEATHERED_CUT_COPPER, NoteBlockInstrument.TRUMPET_WEATHERED)
            .put(ChunkerVanillaBlockType.EXPOSED_CUT_COPPER, NoteBlockInstrument.TRUMPET_EXPOSED)
            .put(ChunkerVanillaBlockType.CUT_COPPER, NoteBlockInstrument.TRUMPET)
            .put(ChunkerVanillaBlockType.OXIDIZED_CHISELED_COPPER, NoteBlockInstrument.TRUMPET_OXIDIZED)
            .put(ChunkerVanillaBlockType.WEATHERED_CHISELED_COPPER, NoteBlockInstrument.TRUMPET_WEATHERED)
            .put(ChunkerVanillaBlockType.EXPOSED_CHISELED_COPPER, NoteBlockInstrument.TRUMPET_EXPOSED)
            .put(ChunkerVanillaBlockType.CHISELED_COPPER, NoteBlockInstrument.TRUMPET)
            .put(ChunkerVanillaBlockType.WAXED_OXIDIZED_CHISELED_COPPER, NoteBlockInstrument.TRUMPET_OXIDIZED)
            .put(ChunkerVanillaBlockType.WAXED_WEATHERED_CHISELED_COPPER, NoteBlockInstrument.TRUMPET_WEATHERED)
            .put(ChunkerVanillaBlockType.WAXED_EXPOSED_CHISELED_COPPER, NoteBlockInstrument.TRUMPET_EXPOSED)
            .put(ChunkerVanillaBlockType.WAXED_CHISELED_COPPER, NoteBlockInstrument.TRUMPET)
            .put(ChunkerVanillaBlockType.OXIDIZED_CUT_COPPER_STAIRS, NoteBlockInstrument.TRUMPET_OXIDIZED)
            .put(ChunkerVanillaBlockType.WEATHERED_CUT_COPPER_STAIRS, NoteBlockInstrument.TRUMPET_WEATHERED)
            .put(ChunkerVanillaBlockType.EXPOSED_CUT_COPPER_STAIRS, NoteBlockInstrument.TRUMPET_EXPOSED)
            .put(ChunkerVanillaBlockType.CUT_COPPER_STAIRS, NoteBlockInstrument.TRUMPET)
            .put(ChunkerVanillaBlockType.OXIDIZED_CUT_COPPER_SLAB, NoteBlockInstrument.TRUMPET_OXIDIZED)
            .put(ChunkerVanillaBlockType.WEATHERED_CUT_COPPER_SLAB, NoteBlockInstrument.TRUMPET_WEATHERED)
            .put(ChunkerVanillaBlockType.EXPOSED_CUT_COPPER_SLAB, NoteBlockInstrument.TRUMPET_EXPOSED)
            .put(ChunkerVanillaBlockType.CUT_COPPER_SLAB, NoteBlockInstrument.TRUMPET)
            .put(ChunkerVanillaBlockType.WAXED_COPPER_BLOCK, NoteBlockInstrument.TRUMPET)
            .put(ChunkerVanillaBlockType.WAXED_WEATHERED_COPPER, NoteBlockInstrument.TRUMPET_WEATHERED)
            .put(ChunkerVanillaBlockType.WAXED_EXPOSED_COPPER, NoteBlockInstrument.TRUMPET_EXPOSED)
            .put(ChunkerVanillaBlockType.WAXED_OXIDIZED_COPPER, NoteBlockInstrument.TRUMPET_OXIDIZED)
            .put(ChunkerVanillaBlockType.WAXED_OXIDIZED_CUT_COPPER, NoteBlockInstrument.TRUMPET_OXIDIZED)
            .put(ChunkerVanillaBlockType.WAXED_WEATHERED_CUT_COPPER, NoteBlockInstrument.TRUMPET_WEATHERED)
            .put(ChunkerVanillaBlockType.WAXED_EXPOSED_CUT_COPPER, NoteBlockInstrument.TRUMPET_EXPOSED)
            .put(ChunkerVanillaBlockType.WAXED_CUT_COPPER, NoteBlockInstrument.TRUMPET)
            .put(ChunkerVanillaBlockType.WAXED_OXIDIZED_CUT_COPPER_STAIRS, NoteBlockInstrument.TRUMPET_OXIDIZED)
            .put(ChunkerVanillaBlockType.WAXED_WEATHERED_CUT_COPPER_STAIRS, NoteBlockInstrument.TRUMPET_WEATHERED)
            .put(ChunkerVanillaBlockType.WAXED_EXPOSED_CUT_COPPER_STAIRS, NoteBlockInstrument.TRUMPET_EXPOSED)
            .put(ChunkerVanillaBlockType.WAXED_CUT_COPPER_STAIRS, NoteBlockInstrument.TRUMPET)
            .put(ChunkerVanillaBlockType.WAXED_OXIDIZED_CUT_COPPER_SLAB, NoteBlockInstrument.TRUMPET_OXIDIZED)
            .put(ChunkerVanillaBlockType.WAXED_WEATHERED_CUT_COPPER_SLAB, NoteBlockInstrument.TRUMPET_WEATHERED)
            .put(ChunkerVanillaBlockType.WAXED_EXPOSED_CUT_COPPER_SLAB, NoteBlockInstrument.TRUMPET_EXPOSED)
            .put(ChunkerVanillaBlockType.WAXED_CUT_COPPER_SLAB, NoteBlockInstrument.TRUMPET)
            ...
            .put(ChunkerVanillaBlockType.VAULT, NoteBlockInstrument.BASEDRUM)
            .put(ChunkerVanillaBlockType.HEAVY_CORE, NoteBlockInstrument.SNARE)
            .put(ChunkerVanillaBlockType.RESIN_BLOCK, NoteBlockInstrument.BASEDRUM)
